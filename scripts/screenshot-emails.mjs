#!/usr/bin/env node
// One-off check for the Pipeline page's email enrichment dialog.
...
await page.getByRole("button", { name: /Find emails|Emails/ }).first().click();
await page.waitForTimeout(300);
await page.screenshot({ path: path.join(outDir, "emails-dialog.png") });
console.log("Saved emails-dialog.png");
await browser.close();
server.kill();
process.exit(0);
